...
/// Value object representing the validation and execution status of a Current Affairs
/// ingestion operation.
@immutable
class CurrentAffairsValidationResult {
  ...
  /// Constructs an immutable [CurrentAffairsValidationResult].
  CurrentAffairsValidationResult({
  ...
  /// Creates a copy of this [CurrentAffairsValidationResult] with updated fields.
  CurrentAffairsValidationResult copyWith({
    bool? success,
  ...
  /// Deserializes a [CurrentAffairsValidationResult] from a Map.
  factory CurrentAffairsValidationResult.fromMap(Map<String, dynamic> map) {
    return CurrentAffairsValidationResult(
  ...
  bool operator ==(Object other) {
    ...
    return other is CurrentAffairsValidationResult &&
  ...
  @override
  String toString() {
    return 'CurrentAffairsValidationResult(success: $success, isValid: $isValid, errors: ${errors.length}, warnings: ${warnings.length})';
  }
